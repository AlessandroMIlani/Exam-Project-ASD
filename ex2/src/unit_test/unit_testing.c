...
static void test_empety_search() {
	TEST_ASSERT_FALSE(search_skiplist(list, &i1));
}

static void test_non_emepety_missing_search() {
	insert_list(list, &i2);
	insert_list(list, &i3);
	insert_list(list, &i4);
	TEST_ASSERT_FALSE(search_skiplist(list, &i1));
...
static void test_non_emepety_present_search() {
	insert_list(list, &i1);
	insert_list(list, &i2);
	insert_list(list, &i3);
	insert_list(list, &i4);
...
int main() {
	UNITY_BEGIN();
	RUN_TEST(test_order);
	RUN_TEST(test_empety_search);
	RUN_TEST(test_non_emepety_missing_search);
	RUN_TEST(test_non_emepety_present_search);
